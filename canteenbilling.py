...
#---------------title---------------
title=Label(wn,text="RGMCET CANTEEN",bg="orange",fg="black",font="times 40 bold")#label for name of canteen
title.pack(fill=X)
...
br2=Label(f1,text="Welcome To RGMCET CAFETERIA",font="arial 13 bold").pack()
